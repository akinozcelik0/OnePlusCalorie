...
namespace OnePlusCalorie.DAL.Migrations
{
    ...
    [Migration("20221202002636_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnePlusCalorie.DATA.Entities.Besin", b =>
                {
                    ...
                    b.Property<int>("BesininKategorisiID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BesininKategorisiID");
            ...
            modelBuilder.Entity("OnePlusCalorie.DATA.Entities.Besin", b =>
                {
                    b.HasOne("OnePlusCalorie.DATA.Entities.BesinKategori", "BesininKategorisi")
                        .WithMany("KategorininBesinleri")
                        .HasForeignKey("BesininKategorisiID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BesininKategorisi");
                });
