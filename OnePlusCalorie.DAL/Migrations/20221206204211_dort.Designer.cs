...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnePlusCalorie.DATA.Entities.ProfilOgun", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OgunDetaylariID")
                        .HasColumnType("int");

                    b.Property<int>("ProfillerID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("OgunDetaylariID");

                    b.HasIndex("ProfillerID");

                    b.ToTable("ProfilOgunTablolari");
                });
            ...
            modelBuilder.Entity("OnePlusCalorie.DATA.Entities.ProfilOgun", b =>
                {
                    b.HasOne("OnePlusCalorie.DATA.Entities.OgunDetaylari", "OgunDetaylari")
                        .WithMany()
                        .HasForeignKey("OgunDetaylariID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnePlusCalorie.DATA.Entities.ProfilBilgisi", "Profiller")
                        .WithMany()
                        .HasForeignKey("ProfillerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OgunDetaylari");

                    b.Navigation("Profiller");
                });
